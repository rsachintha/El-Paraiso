...
<html lang="en">
    ...
    <body>
        ...
        <section class="ftco-section">
            <div class="container">
                <h1 style="text-align: center; font-size: 60px; color: goldenrod">Error Occurred!</h1>
                <h2 style="text-align: center; font-size: 45px; color: goldenrod">Please Try Again</h2>
            </div>
        </section>
