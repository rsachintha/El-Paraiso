            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="joinnow.jsp" class="nav-link">Join Now</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="text">
                            ...
                            <h1 class="mb-4 bread">Feedbacks</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row block-9">
                    <div class="col-md-6 order-md-last d-flex">
                        <form action="addFeedback" method="post" class="bg-white p-5 contact-form">
                            ...
                            <div class="form-group">
                                <input name="sbjct" type="text" class="form-control" placeholder="Subject" />
                            </div>
                            <div class="form-group">
                                <textarea
                                    name="msg"
                    ...
                    <div class="col-md-6 d-flex">
                        <div><img src="images/bg_3.jpg" style="width: 100%; filter:brightness(80%)"></div>
                    </div>
                </div>
            </div>
        </section>
