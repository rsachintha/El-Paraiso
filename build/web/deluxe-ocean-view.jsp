                ...
                <div
                    ...
                    <div
                        ...
                        <div class="text">
                            ...
                            <h1 class="mb-4 bread">Deluxe Ocean View Room</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-md-12 ftco-animate">
                                <div class="single-slider owl-carousel">
                                    ...
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/room1.1.jpg)"
                                            ></div>
                                    </div>
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/room1.2.jpg)"
                                            ></div>
                                    </div>
                                </div>
                            </div>
                            <div class="room-info">
                                ...
                                <p>
                                    Deluxe Ocean View Rooms are beautifully appointed with a
                                    contemporary design and local Sri Lankan touches. All rooms
                                    look out over the Indian Ocean or Colombo cityscape.
                                </p>
                            ...
                            <div class="book-now-btn">
                                <a href="booking.jsp"
                                   ><button class="bknw-btn">Book Now</button></a
                                >
                            </div>
                        </div>
                    </div>
