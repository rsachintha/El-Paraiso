                    ...
                    <div
                        ...
                        <div class="text">
                            <p class="breadcrumbs mb-2">
                                ...
                                <span>Speciality Suite</span>
                            </p>
                            <h1 class="mb-4 bread">Speciality Suite</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-12 ftco-animate">
                                <div class="single-slider owl-carousel">
                                    ...
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/suit2.1.jpg)"
                                            ></div>
                                    </div>
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/suit2.2.jpg)"
                                            ></div>
                                    </div>
                                </div>
                            </div>
                            <div class="room-info">
                                <h3>Exquisite Sanctuary</h3>
                                <p>
                                    Overlooking the Indian Ocean and the city, our luxurious
                                    Specialty Suites offer a contemporary design with a warm Sri
                                    Lankan touch. The suite comprises a spacious guest room and a
                                ...
                                <ul>
                                    ...
                                    <li class="ul-li">
                                        Access to the exclusive Horizon Club Lounge and full range
                                        of privileges.
                                    </li>
                                </ul>
