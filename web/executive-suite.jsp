                ...
                <div
                    ...
                    <div
                        ...
                        <div class="text">
                            ...
                            <h1 class="mb-4 bread">Executive Suite</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-md-12 ftco-animate">
                                <div class="single-slider owl-carousel">
                                    ...
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/suit1.1.jpg)"
                                            ></div>
                                    </div>
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/suit1.2.jpg)"
                                            ></div>
                                    </div>
                                </div>
                            </div>
                            <!--Room-->
                            <div class="room-info">
                                <h3>Staying In Style</h3>
                                <p>
                                    Our Executive Suites are beautifully appointed and include a
                                    spacious guest room and separate living room with impressive
                                ...
                                <ul>
                                    <li class="ul-li">
                                        Each room offers 84 sqm / 904 sqf of luxury.
                                    </li>
