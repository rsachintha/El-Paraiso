                    ...
                    <div
                        ...
                        <div class="text">
                            <p class="breadcrumbs mb-2">
                                ...
                                <span>Deluxe Nature View Room</span>
                            </p>
                            <h1 class="mb-4 bread">Deluxe Nature View Room</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-md-12 ftco-animate">
                                <div class="single-slider owl-carousel">
                                    ...
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/room4.1.jpg)"
                                            ></div>
                                    </div>
                                    <div class="item">
                                        <div
                                            class="room-img"
                                            style="background-image: url(images/room4.2.jpg)"
                                            ></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!--Room-->
                            <div class="room-info">
                                <h3>Tasteful Interiors, Nature Panoramas</h3>
                                <p>
                                    Deluxe Rooms offer space and comfort with thoughtful
                                    contemporary design and local Sri Lankan touches. All rooms
                                    offer exceptional views over the Lake and the city beyond.
                                </p>
