...
public class addFeedback extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Feedbacks fedModel = new  Feedbacks(name,email,sbjct,msg);
        
        DatabaseHelper addFed = new DatabaseHelper(DatabaseConnector.getConnection());
        if(addFed.addFdback(fedModel)){
